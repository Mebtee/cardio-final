...
--
-- Table structure for table `patient_edit_requests`
--
...
--
-- Dumping data for table `patient_edit_requests`
--
...
(1, 'admin', '$2b$12$AVoWfnOZQSVXL4JRtFxOKuGsZVAtQt5QNTKJM1c8Ot/vXQu6YScw2', 'admin@heartsight.com', 'admin', 'System Administrator', '2025-11-11 19:14:21', NULL, 0),
(2, 'doctor1', '$2b$12$zVL/XZr7b1hRVcWK2wqkUudpwdfEgsU1hjkTUwjXFuW/zOr8vNa5C', 'doctor1@heartsight.com', 'doctor', 'Dr. John Smith', '2025-11-11 19:14:21', 'cardiology', 0),
(3, 'technician1', '$2b$12$s1DKkEmSt5Pm36NuSsz30e03ZGA6u7KBWXnFBNjSukaofy/lJ49uq', 'tech1@heartsight.com', 'xray_technician', 'Jane Doe', '2025-11-11 19:14:21', NULL, 0),
...
--
-- Indexes for table `patient_edit_requests`
--
...
--
-- AUTO_INCREMENT for table `patient_edit_requests`
--
ALTER TABLE `patient_edit_requests`
...
--
-- Constraints for table `patient_edit_requests`
--
ALTER TABLE `patient_edit_requests`
  ADD CONSTRAINT `patient_edit_requests_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `patient_edit_requests_ibfk_2` FOREIGN KEY (`requested_by`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `patient_edit_requests_ibfk_3` FOREIGN KEY (`reviewed_by`) REFERENCES `users` (`id`) ON DELETE SET NULL;
